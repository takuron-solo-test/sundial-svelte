<script lang="ts">
	...
	function createGnomon() {
		...
		const gnomonWidth = 0.08;
		const gnomonDepth = 0.6;
		...
		const tipGeometry = new THREE.ConeGeometry(0.05, 0.15, 16);
		...
		tip.position.y = 2.96 + gnomonHeight;
